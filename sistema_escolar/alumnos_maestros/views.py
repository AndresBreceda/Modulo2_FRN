...
def index(request):
    ...
    context = {
        ...
        "maestros_recientes": Maestro.objects.filter(activo=True).order_by("-id")[:5],
    }

    return render(
        request,
        "alumnos_maestros/index.html",
        context
    )
...
def alumno_list(request):
    ...
    return render(
        request,
        "alumnos_maestros/alumno_list.html",
        {
            "alumnos": alumnos,
            "q": q,
        },
...
def alumno_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        messages.success(
            request,
            f"Alumno {alumno.matricula} registrado correctamente."
        )
        return redirect("alumno_list")

    return render(
        request,
        "alumnos_maestros/alumno_form.html",
        {
            "form": form,
            "titulo": "Nuevo alumno",
        },
...
def maestro_list(request):
    ...
    return render(
        request,
        "alumnos_maestros/maestro_list.html",
        {
            "maestros": maestros,
            "q": q,
        },
...
def maestro_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        messages.success(
            request,
            f"Maestro {maestro.numero_empleado} registrado correctamente."
        )
    ...
    return render(
        request,
        "alumnos_maestros/maestro_form.html",
        {
            "form": form,
...
def materia_list(request):
    ...
    return render(
        request,
        "alumnos_maestros/materia_list.html",
        {
            "materias": materias,
            "q": q,
        },
...
def materia_create(request):
    ...
    return render(
        request,
        "alumnos_maestros/materia_form.html",
        {
            "form": form,
...
def inscripcion_list(request):
    ...
    return render(
        request,
        "alumnos_maestros/inscripcion_list.html",
        {
...
def inscripcion_create(request):
    ...
    return render(
        request,
        "alumnos_maestros/inscripcion_form.html",
        {
            "form": form,
...
def inscripcion_deactivate(request, pk):
    ...
    messages.success(request, "Inscripción desactivada correctamente.")
